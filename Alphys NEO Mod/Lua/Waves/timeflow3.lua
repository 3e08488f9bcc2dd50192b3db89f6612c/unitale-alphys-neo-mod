...
if (GetGlobal("justTaunted") == true) then
	...
	table.insert(flow, { icon = "rec", start = 1.1, mult = 1.1, dir = 1, rate = 0, length = 10.7, blink = 1.5 })
	...
	table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = 510, endX = 184, endY = 160+(rand1*50), time = ourTime+8.8, rotation = 270, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
	table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = 510, endX = 320+(rand2*50), endY = 290, time = ourTime+8.8, rotation = 0, size = NORMAL, laserDelay = 0.8, laserLength = 0.55 }))
	
	table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = 456, endY = 160+(rand3*50), time = ourTime+10.3, rotation = 90, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = true, rs1 = false }))
	table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = 320+(rand4*50), endY = 30, time = ourTime+10.3, rotation = 180, size = NORMAL, laserDelay = 0.8, laserLength = 0.55 }))

	
else
	table.insert(flow, { icon = "rec", start = 1.0, mult = 1.0, dir = 1, rate = 0, length = 8.7 })
	table.insert(flow, { icon = "rew", start = 1.0, mult = -1.25, dir = -1, rate = -2.1, length = 9, blink = 2 })
end

--Corner metts
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 190, startY = 65, time = ourTime, ammo = 99, delay = 4, firstShot = 1, flingDir = -1, bounce = false } ))
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 190, startY = 280, time = ourTime, ammo = 99, delay = 4, firstShot = 2, flingDir = -1, bounce = false } ))
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 450, startY = 280, time = ourTime, ammo = 99, delay = 4, firstShot = 3, flingDir = -1, bounce = false } ))
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 450, startY = 65, time = ourTime, ammo = 99, delay = 4, firstShot = 4, flingDir = -1, bounce = false } ))
...
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = 510, endX = 468, endY = -42, time = ourTime+5.9, rotation = 90, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = -30, endX = -42, endY = 50, time = ourTime+5.9, rotation = 180, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = true, s2 = true }))
if (GetGlobal("justTaunted") == true) then
	table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = 510, endX = 172, endY = -42, time = ourTime+7.2, rotation = 270, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
else
	table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = 510, endX = 172, endY = -42, time = ourTime+7.2, rotation = 270, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = true, rs1 = false }))
end
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = -42, endY = 50, time = ourTime+7.2, rotation = 180, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = true, s2 = true }))
...
function Update()
	...
	if (GetGlobal("justTaunted") == true) then
		if (allMettsShot == 0 and waveTimeDiff > 10.1) then
			allMettsShot = 1
			Audio.PlaySound("attack8")
		end
	elseif (allMettsShot == 0 and waveTimeDiff > 8) then
		allMettsShot = 1
		Audio.PlaySound("attack8")
	end
