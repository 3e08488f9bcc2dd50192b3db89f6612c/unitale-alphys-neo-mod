...
for i = 4,90,6 do
	if (math.random(0,1,2) == 0) then
		...
		table.insert(bots, { startX = -85, startY = 430, endX = 5000, endY = -5000, time = Time.time + i, speed = 180, rotation = 0, color = ORANGE })
	elseif (math.random(0,1,2) == 1) then
		table.insert(bots, { startX = 690, startY = 430, endX = -5000, endY = -5000, time = Time.time + i, speed = 180, rotation = 0, color = BLUE })
		table.insert(bots, { startX = 655, startY = 430, endX = -5000, endY = -5000, time = Time.time + i, speed = 180, rotation = 0, color = ORANGE })
                     else
		table.insert(bots, { startX = -50, startY = 430, endX = 5000, endY = -5000, time = Time.time + i, speed = 180, rotation = 0, color = BLUE })
		table.insert(bots, { startX = 655, startY = 430, endX = -5000, endY = -5000, time = Time.time + i, speed = 170, rotation = 0, color = ORANGE })
	end
end
