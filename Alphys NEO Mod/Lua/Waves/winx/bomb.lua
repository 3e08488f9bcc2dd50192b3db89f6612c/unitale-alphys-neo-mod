...
Arena.Resize(48,130)
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 200, startY = 220, time = ourTime, ammo = 99, delay = 5.5, firstShot = 1, flingDir = -1, bounce = false } ))
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 420, startY = 220, time = ourTime, ammo = 99, delay = 5.5, firstShot = 5, flingDir = -1, bounce = false } ))

table.insert(pmetts, oblib.Parasol.new( { lifetime = 5, startX = 160, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1, time = ourTime + 1.7, ammo = 3, delay = 1.2, firstShot = 0.8, flingDir = -1 }))
table.insert(pmetts, oblib.Parasol.new( { lifetime = 5, startX = 480, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1, time = ourTime + 1.7, ammo = 3, delay = 1.2, firstShot = 0.8, flingDir = 1 }))
--1
table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = 331, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+0.2 }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 307, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+0.2 }))
--2
table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = 307, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+0.7 }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 331, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+0.7 }))
--3
table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = 331, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+1.2 }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 307, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+1.2 }))
--4
table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = 307, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -250, time = ourTime+1.7 }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 331, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -250, time = ourTime+1.7 }))
--5
table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = 331, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+2.2 }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 307, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+2.2 }))
--6
table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = 307, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+2.7 }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 331, startY = 500, endX = 240, endY = -1000, xspeed = 0, yspeed = -240, time = ourTime+2.7 }))
--7
table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 331, startY = 564, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime+3.3, bottomScreenDead = true }))
table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 307, startY = 564, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime+3.3, bottomScreenDead = true }))
table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 331, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime+3.3, bottomScreenDead = true }))
table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 307, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime+3.3, bottomScreenDead = true }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 331, startY = 579, endX = 240, endY = -1000, xspeed = 0, yspeed = -119, time = ourTime+3.4 }))
table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = 307, startY = 579, endX = 240, endY = -1000, xspeed = 0, yspeed = -119, time = ourTime+3.4 }))
--8
...
Encounter.SetVar("wavetimer", 13.0)
	...
	table.insert(flow, { icon = "ff", start = 1.0, mult = 1.2, dir = 1, rate = 0.2, length = 8 })
	table.insert(flow, { icon = "rew", start = 1.0, mult = -1.1, dir = 1, rate = -2.2, length = 9, blink = 2 })
end
