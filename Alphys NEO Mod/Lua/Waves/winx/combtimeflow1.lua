...
--Blasters
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = 320+120, endY = 105, time = ourTime+3.0, rotation = 90, size = THIN, laserDelay = 0.9, laserLength = 0.5, s1 = false, s2 = false, rs1 = false, rs2 = false, rev = true }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = 510, endX = 320+120, endY = 215, time = ourTime+3.0, rotation = 90, size = THIN, laserDelay = 0.9, laserLength = 0.5, s1 = true, s2 = true }))
