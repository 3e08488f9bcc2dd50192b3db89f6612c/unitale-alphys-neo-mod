...
blackbullet = CreateProjectileAbs("/modded/blackfade/black",325,230)
...
if (GetGlobal("attackNum") > 10) then
	...
	for i = 248,392,24 do
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -60, time = ourTime + 5.4, bottomScreenDead = true }))		
	end
