...
table.insert(circles, { radius = 42, offset = 0 } )
--Circle 6: constant, for mett shield
table.insert(circles, { radius = 45, offset = 0 } )
--Circle 7: constant, for mett shield
table.insert(circles, { radius = 45, offset = 0 } )
--Circle 8: constant radius unshoot box
table.insert(circles, { radius = 70, offset = 0 } )
--Circle 9: constant radius outer bomb
table.insert(circles, { radius = 90, offset = 0 } )
...
local d = 1.5
	...
	table.insert(pmetts, oblib.Parasol.new( { startX = 320 - 4, startY = 640+12, endX = 0, endY = 360+12, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + d, ammo = 99, delay = 0.1, firstShot = 1.0, flingDir = -1, bounce = false }))
	...
	table.insert(shieldMetts, pmetts[#pmetts])
	for j = 0, 320, 40 do
		table.insert(sboxes, oblib.ShootableBox.new( { circleID = 5, rotation = j, rspeed = 100, startX = 320, startY = 640, endX = 0, endY = 360, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + d, bounce = false }))
		table.insert(boxes, oblib.Box.new( { circleID = 8, rotation = j, rspeed = 50, startX = 320, startY = 640, endX = 0, endY = 360, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + d, bounce = false }))
	                     table.insert(sboxes, oblib.ShootableBox.new( { circleID = 9, rotation = j, rspeed = 75, startX = 320, startY = 641, endX = 0, endY = 358, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + d, bounce = false }))
	                     table.insert(pbombs, oblib.PlusBomb.new( { circleID = 9, rotation = j, rspeed = 75, startX = 320, startY = 641, endX = 0, endY = 359, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + d, bounce = false }))
	end
