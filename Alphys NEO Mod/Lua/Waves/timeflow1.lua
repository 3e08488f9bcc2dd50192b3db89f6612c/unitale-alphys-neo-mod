...
Normal Mode changes:
Reduce RNG/unfairness on shootable box location
Slowed down boxes, removed one row
Shifted other timings because of the boxes
...
for i = 500,700,200 do
	...
	for j = 0,3,1 do
		if (j == box1 or j == box2) then
			table.insert(sboxes, oblib.ShootableBox.new({ simple = true, startX = 282+26*j, startY = i, yspeed = -180, time = ourTime + 0 } ))
		else
			table.insert(pbombs, oblib.PlusBomb.new({ simple = true, startX = 282+26*j, startY = i, yspeed = -180, time = ourTime + 0 } ))
		end
	end
end
...
--Blasters
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = 320+120, endY = 105, time = ourTime+1.8, rotation = 90, size = THIN, laserDelay = 0.9, laserLength = 0.5, s1 = false, s2 = false, rs1 = false, rs2 = false, rev = true }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = 510, endX = 320+120, endY = 215, time = ourTime+1.8, rotation = 90, size = THIN, laserDelay = 0.9, laserLength = 0.5, s1 = true, s2 = true }))

table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = -30, endX = 320-120, endY = 160, time = ourTime+3.3, rotation = 270, size = NORMAL, laserDelay = 0.9, laserLength = 0.5, s1 = false, s2 = false, rs1 = false, rs2 = false, rev = true }))
...
--Bunch of Metts.
for i = 300,340,40 do
	table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 140, xspeed2 = 0, yspeed2 = 40, speedTime = 0.8, time = ourTime + 4.6, ammo = 99, delay = 1, firstShot = 0.6, flingDir = -1, bounce = false } ))
end
for i = 280,360,40 do
	table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, startX = i, startY = 520, endX = 0, endY = -5000, xspeed = 0, yspeed = 140, xspeed2 = 0, yspeed2 = 40, speedTime = 0.8, time = ourTime + 4, ammo = 99, delay = 1, firstShot = 0.6, flingDir = -1, bounce = false } ))
end
