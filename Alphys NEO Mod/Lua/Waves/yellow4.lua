...
waveLength = 11
Encounter.SetVar("wavetimer", 11.0)
Arena.Resize(168,130)

--This will create a line of 7 of the same object, spaced 24 pixels
for i = 248,392,24 do
	table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + 0, bottomScreenDead = true }))
	table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (24/150), bottomScreenDead = true }))
	table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (48/150), bottomScreenDead = true }))
	--You may accidentally hit these bombs while shooting the wall of blocks~
	table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + 2.2, bottomScreenDead = true }))
end
for i = 0,0.5,0.25 do
...
for i = 250,382,44 do
	...
	table.insert(pmetts, oblib.Parasol.new( { startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 3.8, ammo = 10, delay = 1, firstShot = 1.2, flingDir = -1 }))
end
