...
--Corner metts
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 180, startY = 55, time = ourTime, ammo = 99, delay = 4, firstShot = 1, flingDir = -1, bounce = false } ))
...
table.insert(pmetts, oblib.Parasol.new({ heartsDie = false, simple = true, startX = 460, startY = 55, time = ourTime, ammo = 99, delay = 4, firstShot = 4, flingDir = -1, bounce = false } ))
