...
for i = 0,320,40 do
	table.insert(bolts, oblib.Bolt.new( { simple = true, lifetime = 3, circleID = 2, rotation = i, rspeed = 360, startX = 50, startY = 540, endX = 1000, endY = -5000, xspeed = 160, yspeed = -240, time = ourTime + 2 }))
	table.insert(bolts, oblib.Bolt.new( { simple = true, lifetime = 3, circleID = 3, rotation = i, rspeed = 360, startX = 590, startY = 540, endX = -1000, endY = -5000, xspeed = -130, yspeed = -220, time = ourTime + 2.6 }))
end
...
if (GetGlobal("attackNum") > 10) then
	...
	waveLength = 60
	table.insert(flow, { icon = "ff", start = 1.25, mult = 1.25, dir = 1, rate = 0.2, length = 60, blink = 2 })
	
	table.insert(pmetts, oblib.Parasol.new( { startX = 260 - 4, startY = 700+12, endX = 0, endY = 360+12, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, ammo = 99, delay = 2.5, firstShot = 1.5, flingDir = -1, bounce = false }))
	table.insert(shieldMetts, pmetts[#pmetts])
	for j = 0, 320, 40 do
		table.insert(sboxes, oblib.ShootableBox.new( { circleID = 4, rotation = j, rspeed = -90, startX = 260, startY = 700, endX = 0, endY = 360, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, bounce = false }))
	end

	table.insert(pmetts, oblib.Parasol.new( { startX = 320 - 4, startY = 640+12, endX = 0, endY = 300+12, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, ammo = 99, delay = 1, firstShot = 1.2, flingDir = -1, bounce = false }))
	table.insert(shieldMetts, pmetts[#pmetts])
	for j = 0, 320, 40 do
		table.insert(sboxes, oblib.ShootableBox.new( { circleID = 5, rotation = j, rspeed = 100, startX = 320, startY = 640, endX = 0, endY = 300, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, bounce = false }))
	end

	table.insert(pmetts, oblib.Parasol.new( { startX = 380 - 4, startY = 700+12, endX = 0, endY = 360+12, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, ammo = 99, delay = 2.5, firstShot = 1.5, flingDir = -1, bounce = false }))
	table.insert(shieldMetts, pmetts[#pmetts])
	for j = 0, 320, 40 do
		table.insert(sboxes, oblib.ShootableBox.new( { circleID = 6, rotation = j, rspeed = -90, startX = 380, startY = 700, endX = 0, endY = 360, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, bounce = false }))
	end
	
	table.insert(pmetts, oblib.Parasol.new( { startX = 320 - 4, startY = 760+12, endX = 0, endY = 420+12, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, ammo = 99, delay = 1.5, firstShot = 1.8, flingDir = -1, bounce = false }))
	table.insert(shieldMetts, pmetts[#pmetts])
	for j = 0, 320, 40 do
		table.insert(sboxes, oblib.ShootableBox.new( { circleID = 7, rotation = j, rspeed = 100, startX = 320, startY = 760, endX = 0, endY = 420, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, bounce = false }))
	end
	
else
	table.insert(pmetts, oblib.Parasol.new( { startX = 260 - 4, startY = 740+12, endX = 0, endY = 400+12, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, ammo = 99, delay = 2, firstShot = 1.5, flingDir = -1, bounce = false }))
	table.insert(shieldMetts, pmetts[#pmetts])
	for j = 0, 320, 40 do
		table.insert(sboxes, oblib.ShootableBox.new( { circleID = 4, rotation = j, rspeed = -90, startX = 260, startY = 740, endX = 0, endY = 400, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, bounce = false }))
	end
	...
	table.insert(pmetts, oblib.Parasol.new( { startX = 380 - 4, startY = 740+12, endX = 0, endY = 400+12, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, ammo = 99, delay = 2, firstShot = 1.5, flingDir = -1, bounce = false }))
	table.insert(shieldMetts, pmetts[#pmetts])
	for j = 0, 320, 40 do
		table.insert(sboxes, oblib.ShootableBox.new( { circleID = 6, rotation = j, rspeed = -90, startX = 380, startY = 740, endX = 0, endY = 400, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 60, speedTime = 1.5, time = ourTime + 2.6, bounce = false }))
	end
...
for i = 0, 90, 4.2 do
	...
	if (nextSpawn == 0) then
		...
		if (pos == 0) then
			table.insert(gbs, oblib.GasterBlaster.new( { lifetime = 5, startX = 670, startY = 510, endX = 468, endY = -42, time = ourTime+5.5+i, rotation = 90, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false }))
			table.insert(gbs, oblib.GasterBlaster.new( { lifetime = 5, startX = -30, startY = -30, endX = -42, endY = 50, time = ourTime+5.5+i, rotation = 180, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = true, s2 = true }))
		else
			table.insert(gbs, oblib.GasterBlaster.new( { lifetime = 5, startX = -30, startY = 510, endX = 172, endY = -42, time = ourTime+5.5+i, rotation = 270, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false }))
			table.insert(gbs, oblib.GasterBlaster.new( { lifetime = 5, startX = 670, startY = -30, endX = -42, endY = 50, time = ourTime+5.5+i, rotation = 180, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = true, s2 = true }))
		end
...
function Update()
	...
	if (ourWaveTimeDiff > 2) then
		circles[2].radius = 10 + (ourWaveTimeDiff - 2) * 18
	end
	
	if (ourWaveTimeDiff > 2.5) then
		circles[3].radius = 10 + (ourWaveTimeDiff - 2.5) * 18
	end
