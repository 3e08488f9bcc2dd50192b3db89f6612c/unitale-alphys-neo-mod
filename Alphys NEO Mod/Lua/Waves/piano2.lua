...
if (GetGlobal("attackNum") > 10) then
	...
	waveLength = 18
	Encounter.SetVar("wavetimer", 18.0)
	table.insert(flow, { icon = "rec", start = 1.25, mult = 1.25, dir = 1, rate = 0, length = 5, blink = 2 })
	table.insert(flow, { icon = "rec", start = 1.25, mult = 1.4, dir = 1, rate = 0.2, length = 4.6, blink = 2 })
	--table.insert(flow, { icon = "ff", start = 1.25, mult = 1.4, dir = 1, rate = 0.2, length = 6, blink = 2 })
	table.insert(flow, { icon = "rew", start = 1.25, mult = -1.4, dir = -1, rate = -1.8, length = 12, blink = 2 })

else
	table.insert(flow, { icon = "play", start = 1.0, mult = 1.0, dir = 1, rate = 0, length = 9 })
	table.insert(flow, { icon = "ff", start = 1.0, mult = 1.4, dir = 1, rate = 0.2, length = 9, blink = 2 })
end
...
table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = 510, endX = 184, endY = 160+(rand1*22), time = ourTime+2.8, rotation = 270, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = 510, endX = 320+(rand2*22), endY = 290, time = ourTime+3.5, rotation = 0, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = 670, startY = -30, endX = 456, endY = 160+(rand3*22), time = ourTime+4.8, rotation = 90, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = 670, startY = -30, endX = 320+(rand4*22), endY = 30, time = ourTime+4.8, rotation = 180, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = true, s2 = true }))
...
for i = 1,3,1 do
	table.insert(bolts, oblib.Bolt.new({ startX = 256+(i*15), startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp2, time = ourTime + timer + ((418)/ysp2) }))
end
...
--right wall going right
for i = 1,3,1 do
	table.insert(bolts, oblib.Bolt.new({ startX = 341+(i*15), startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp2, time = ourTime + timer + ((418)/ysp2) }))
end
...
--left wall going right
for i = 1,3,1 do
	table.insert(bolts, oblib.Bolt.new({ startX = 301+(i*15), startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp2, time = ourTime + timer + ((498)/ysp2) }))
end
...
for i = 248,392,24 do
	if (i == 272) then
		table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = i, startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp, time = ourTime + 13.3 }))
	else
		table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = i, startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp, time = ourTime + 13.3 }))
	end
end
...
for i = 248,392,24 do
	if (i == 368) then
		table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = i, startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp, time = ourTime + 13.7 }))
	else
		table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = i, startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp, time = ourTime + 13.7 }))
	end
end
...
for i = 248,392,24 do
	if (i == 320) then
		table.insert(pbombs, oblib.PlusBomb.new({ bottomScreenDead = true, simple = true, startX = i, startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp, time = ourTime + 14.1 }))
	else
		table.insert(boxes, oblib.Box.new({ bottomScreenDead = true, simple = true, startX = i, startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = ysp, time = ourTime + 14.1 }))
	end
end

--Blasties covering two of the three rows either horiz or vert
table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = 510, endX = 184, endY = 160+(rand1*22), time = ourTime+16.1, rotation = 270, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = 510, endX = 320+(rand2*22), endY = 290, time = ourTime+16.8, rotation = 0, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = 456, endY = 160+(rand3*22), time = ourTime+18.0, rotation = 90, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = 320+(rand4*22), endY = 30, time = ourTime+18.0, rotation = 180, size = NORMAL, laserDelay = 0.8, laserLength = 0.55, s1 = true, s2 = true }))
